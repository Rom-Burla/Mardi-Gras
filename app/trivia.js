...
const ArreyRd=[

 {
    ...
    question:"It is illegal to wear masks in New Orleans except on Mardi Gras?",
    answer1: "no",
    answer2:"yes",
    ...
    answer2:"Mardi Gras is a French term, which literally translates into “Fat Tuesday”",
...
triviaForm.innerHTML +=`
    <div class="trivia-question">
        ...
        <div class="trivia-answer">
            <input value="${question.answer1}" name="${question.question}" type="radio" id="answer1-${ArreyRd.indexOf(question)}"></input>
            <label for=${question.answer1}>${question.answer1}</label>
        </div>
        <div class="trivia-answer">
            <input value="${question.answer2}" name="${question.question}" type="radio" id="answer2-${ArreyRd.indexOf(question)}"></input>
            <label for=${question.answer2}>${question.answer2}</label>
        </div>
        <div class="trivia-answer">
            <input value="${question.answer3}" name="${question.question}" type="radio" id="answer3-${ArreyRd.indexOf(question)}"></input>
